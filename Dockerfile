...
COPY binaries/jenkinsinstall.sh /usr/local/
RUN chmod +x /usr/local/bin/kubectl-vsphere && chmod +x /usr/local/jenkinsinstall.sh

ENTRYPOINT [ "/usr/local/jenkinsinstall.sh" ]